...
<style type="text/css">
	...
	.header-container.layout6 .widget_shopping_cart:hover .cart-toggler:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -622px -489px no-repeat;
	}
	.wrapper .slick-slider button.slick-prev:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -311px -494px no-repeat;
	}
	.wrapper .slick-slider button.slick-next:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -381px -494px no-repeat;
	}
	.wrapper .carouseltype2 .slick-slider button.slick-prev:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -175px -487px no-repeat;
	}
	.wrapper .carouseltype2 .slick-slider button.slick-next:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -236px -487px no-repeat;
	}
</style>
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper">
		<div class="page-wrapper">
			<div class="header-container layout6">
				<div class="header">
