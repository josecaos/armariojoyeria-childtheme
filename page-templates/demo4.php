...
<style type="text/css">
	...
	.header-container.layout4 .widget_shopping_cart:hover .widget_shopping_cart_content .cart-toggler:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -622px -370px no-repeat;
	}
	.wrapper .carousel-layout4 .slick-slider button.slick-prev:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -457px -373px no-repeat;
	}
	.wrapper .carousel-layout4 .slick-slider button.slick-next:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -523px -373px no-repeat;
	}
	.wrapper .carouseltype2 .slick-slider button.slick-prev:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -175px -366px no-repeat;
	}
	.wrapper .carouseltype2 .slick-slider button.slick-next:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -237px -366px no-repeat;
	}
</style>
	...
	<div class="wrapper">
		<div class="page-wrapper">
			<div class="header-container layout4">
					<?php if(isset($chamo_opt['slider_alias']) && $chamo_opt['slider_alias']!='' ) { ?>
						<div class="home-slider layout4">
						<?php if(function_exists('putRevSlider')) {
						 	putRevSlider($chamo_opt['slider_alias'], "chamo");
						} ?>
						</div>
					<?php } ?>
				<!-- end slider -->
