...
<style type="text/css">
	...
	.header-container.layout5 .header .widget.widget_shopping_cart:hover .cart-toggler:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -622px -432px no-repeat;
	}
	.wrapper .slick-slider button.slick-prev:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -311px -438px no-repeat;
	}
	.wrapper .slick-slider button.slick-next:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -381px -438px no-repeat;
	}
	.wrapper .carouseltype2 .slick-slider button.slick-prev:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -175px -430px no-repeat;
	}
	.wrapper .carouseltype2 .slick-slider button.slick-next:hover:before {
		background: url(../wp-content/themes/chamo/images/chamo-icon.png) -240px -430px no-repeat;
	}
</style>
