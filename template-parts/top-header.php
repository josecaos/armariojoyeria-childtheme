					...
					<?php if ( 'enabled' === $enable_search_bar ) : ?>
						...
						<li class="top-search">
							...
							<form role="search" method="get" class="pull-right" id="searchform_topbar" action="<?php echo esc_url( home_url( '/' ) ); ?>">
								<label>
									<span class="screen-reader-text"><?php esc_html__( 'Busca producto:', 'tyche' ); ?></span>
									<input class="search-field-top-bar" id="search-field-top-bar" placeholder="<?php echo esc_attr__( 'Busca ...', 'tyche' ); ?>" value="" name="s" type="search">
								</label>
