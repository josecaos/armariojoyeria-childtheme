...
?>
	<div class="header-container layout1 <?php if(class_exists('RevSliderFront')) { echo 'rs-active';}?>">
		<div class="header">
				...
				<div class="header-inner">
						<div class="logo-wrap">
							<?php if(is_front_page()) { ?>
								<?php if( isset($chamo_opt['logo_homepage']['url']) ){ ?>
									<div class="logo">
										<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
											<img src="<?php echo esc_url($chamo_opt['logo_homepage']['url']); ?>" alt="" />
										</a>
									</div>
								<?php
								} else { ?>
