...
<div class="main-container full-width">
		...
		<div class="container">
			<div class="title-breadcrumb-inner">
				<header class="entry-header">
					<h1 class="entry-title"><?php esc_html_e('Portfolio', 'chamo');?></h1>
				</header>
	...
	<div class="container">
		...
		<div class="page-content">
			...
			if( isset($chamo_opt['portfolio_per_page']) ) {
				$projects_per_page = $chamo_opt['portfolio_per_page'];
			}
			...
			<?php if ( $projects_query->have_posts() ) : ?>
				...
				<div class="filter-options btn-group">
					<button data-group="all" class="btn active btn--warning"><?php esc_html_e('All', 'chamo');?></button>
					<?php 
					$datagroups = array();
